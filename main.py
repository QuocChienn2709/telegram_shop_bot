...
async def menu_purchase_callback(update, context):
    ...
    if len(text) > 3800:
        ...
        if buf:
            parts.append(buf)
        # Edit message đầu, gửi các phần còn lại
